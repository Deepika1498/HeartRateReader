...
@NonNullApi
public class RuntimePermissionsWearProjectDependency extends DelegatingProjectDependency {

    @Inject
    public RuntimePermissionsWearProjectDependency(TypeSafeProjectDependencyFactory factory, ProjectDependencyInternal delegate) {
